...
java -Djava.protocol.handler.pkgs=org.opendcs.spi.url -Xmx240m -cp !CLASSPATH! -DDCSTOOL_HOME=$INSTALL_PATH -DDECODES_INSTALL_DIR=$INSTALL_PATH -DDCSTOOL_USERDIR=$INSTALL_PATH %*%
