...
java -Xmx240m !DECJ_MAXHEAP! !DEC_DEBUG! !DECJ_JAVA_OPTS! -cp !CLASSPATH! -DDCSTOOL_HOME=$INSTALL_PATH -DDECODES_INSTALL_DIR=$INSTALL_PATH -DDCSTOOL_USERDIR=$INSTALL_PATH %*%
