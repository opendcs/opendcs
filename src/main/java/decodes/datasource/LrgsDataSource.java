		...
		throws DataSourceException
	{
		...
		try
		{
			...
			for(Iterator<String> it = searchCrit.NetlistFiles.iterator(); it.hasNext();)
			{
				...
				NetworkList decNL = 
					Database.getDb().networkListList.getNetworkList(nm);
				if (decNL == null)
				{
...
//			finally
//			{
//Logger.instance().debug3("LrgsDataSource Reseting abortFlag to false.");
//				abortFlag = false;
//			}
...
//			}
	 ...
	 * 'timed-out'.
	 */
	public void setTimeoutSecOnError(int sec) { timeoutSecOnError = sec; }
