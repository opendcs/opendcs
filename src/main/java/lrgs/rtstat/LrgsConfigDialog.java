...
//
        ...
        if (networkListsAddButton == null)
        {
            ...
            networkListsAddButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    //Now network list can be associated with the groups, primary, secondary or both
                    ...
                    Integer res = (Integer)JOptionPane.showOptionDialog(
                            new JFrame(), panel, "Network List",JOptionPane.OK_CANCEL_OPTION,
    ...
    private JCheckBox getEnableDRGSCheck()
    {
        if (enableDRGSCheck == null)
        {
            ...
            enableDRGSCheck.setText(labels.getString("LrgsConfigDialog.enableDRGSConn"));
        }
...
class DdsSortingListTableModel    extends AbstractTableModel
...
class DrgsSortingListTableModel    extends AbstractTableModel
                                implements SortingListTableModel
{
    private static ResourceBundle labels = RtStat.getLabels();
