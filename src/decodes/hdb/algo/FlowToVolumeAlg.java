...
// version 1.0.09 enhanced for the CP upgrade 5.3 project where the surrogate keys where handles in a new DBkey class
...
//
		...
		DataObject dbobj = new DataObject();
                ...
                // this SDI initialization was  modified by M. Bogner Mar 2013 for the dbkey surrogate key i
		...
		if (do_setoutput) 
		{
		   ...
		   if (total_count < mvd_count) flags = flags + "n";
                   ...
                   //  now we have a partial calculation, so do what needs to be done for partials
                   {
                      ...
                      // this call modified by M. Bogner Mar 2013 for the dbkey surrogate key class for the 5.3 CP upgrade project
