...
//   "logStat: prevNum=" + prevNumClients
// + ", last call=" + (new Date(lastLogStatMsec)) 
// + ", elapsedMsec=" + elapsedMsec 
// + ", added=" + added 
// + ", connectMsecs=" + connectMsecs
// + ", ave=" + ave
...
// Logger.instance().info("startNewHour: elapsedMsec=" + elapsedMsec
...
// + ", connectMsecs=" + connectMsecs);
	...
	{
// Logger.instance().info("incrBadUsernames");
