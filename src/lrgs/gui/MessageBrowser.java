...
//		abortButton = new JButton(" Abort Request ");
...
//		filechooser.addChoosableFileFilter(new AllFiles_FileFilter());
...
//			"MessageBrowser.Decode", false));
	...
	{
//		GuiApp.getProperty("MessageBrowser.Help", "http://www.ilexeng.com/"
//			+ LrgsApp.SubDir + "/help/MessageBrowser.html");
...
//	}
	...
	*/
	...
	private boolean checkSearchCriteria()
	{
		...
		if (scedit != null)
		{
			//String lastscstring = searchcrit.toString();
			//SearchCriteria testsc = new SearchCriteria();
			//testsc = scedit.fillSearchCrit();
	...
	*/
	public boolean sendSearchCriteria(SearchCriteria searchcrit)
	{
		...
		String errmsg = null;
		try { client.sendSearchCrit(searchcrit); }
		catch(IOException ioe)
		{
