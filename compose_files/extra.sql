...
insert into identity_provider(name,type,config) values
 ('oidc-pkce', 'OpenIdConnect', '{"clientId": "opendcs-public", "wellKnown": "http://localhost:7100/auth/realms/opendcs/.well-known/openid-configuration", "redirectUri": "http://localhost:7000/oidc-callback"}'::json),
