...
//AW:PROPERTIES
    ...
    protected void doAWTimeSlice() throws DbCompException
    {
        ...
        log.atTrace()
           ...
           .addKeyValue("input10", input20).addKeyValue("coeff10", coeff20)
		   .addKeyValue("input11", input21).addKeyValue("coeff11", coeff21)
		   .addKeyValue("input12", input22).addKeyValue("coeff12", coeff22)
		   .addKeyValue("input13", input23).addKeyValue("coeff13", coeff23)
		   .addKeyValue("input14", input24).addKeyValue("coeff14", coeff24)
		   .addKeyValue("input15", input25).addKeyValue("coeff15", coeff25)
		   .addKeyValue("input16", input26).addKeyValue("coeff16", coeff26)
		   .addKeyValue("input17", input27).addKeyValue("coeff17", coeff27)
		   .addKeyValue("input18", input28).addKeyValue("coeff18", coeff28)
		   .addKeyValue("input19", input29).addKeyValue("coeff19", coeff29)
		   .addKeyValue("input20", input30).addKeyValue("coeff20", coeff30)
		   .log("tally={}", tally);
