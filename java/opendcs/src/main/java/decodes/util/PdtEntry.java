...
public class PdtEntry
{
	    ...
	    throws BadPdtEntryException
	{
		...
		{
			throw new BadPdtEntryException("Bad DCP address '" + f[1] + "'", ex);
		}
		...
		if (c == 'S' || c == 'D')
		{
			...
			{
				throw new BadPdtEntryException("Bad chan params", ex);
			}
			catch (IllegalArgumentException ex)
			{
				throw new BadPdtEntryException("time params", ex);
			}
		}
		else if (c == 'R')
		{
		...
		{
			throw new BadPdtEntryException("Bad baud", ex);
		}
		...
		{
			throw new BadPdtEntryException("Bad LMT", ex);
		}
