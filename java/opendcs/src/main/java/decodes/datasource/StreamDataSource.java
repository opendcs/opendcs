...
public abstract class StreamDataSource extends DataSourceExec
{
    ...
    */
        ...
        throws DataSourceException
    {
        ...
        catch(IOException ex)
        {
            ...
            throw new DataSourceException("Error processing data.", ex);
        }
    }
    ...
    */
        ...
        throws DataSourceException
    {
        ...
        log.trace("readToDelimiter, returning buflen={}", buflen);
        if (buf != null)
        {
            log.trace("buf='{}'", new String(buf, 0, buflen));
        }
        return buflen;
    }
    ...
    */
        ...
        throws DataSourceException
    {
        ...
        {
            throw new DataSourceException("Unable to read entire file.", ex);
        }
