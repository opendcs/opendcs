...
public class SavePanel extends JPanel implements WizardPanel
{
	...
	* method returns false. Implementation should override and check current
	* status, and return a value if appropriate.
	* @return boolean
	*/
	...
	* Implementation should read info in the object and populate fields in the
	* panel.
	*/
	...
	* objects.
	* @return true if OK to deactivate and move-on.
	*/
