...
public interface LoadingAppDAI extends DaiBase, OpenDcsDao
{
	 ...
	 * @throws DbIoException on Database IO error.
	 */
	List<String> listComputationsByApplicationId(DataTransaction tx, DbKey appId, boolean enabledOnly ) throws OpenDcsDataException;
     ...
     * @return list of computations.
     */
    ArrayList<CompAppInfo> listComputationApps(DataTransaction tx, boolean usedOnly) throws OpenDcsDataException;
     ...
     * @return computation app info.
     */
    Optional<CompAppInfo> getComputationApp(DataTransaction tx, DbKey id) throws OpenDcsDataException;
     ...
     * @return computation app info.
     */
    Optional<CompAppInfo> getComputationApp(DataTransaction tx, String name) throws OpenDcsDataException;
     ...
     * @return surrogate key.
     */
    Optional<DbKey> lookupAppId(DataTransaction tx, String name) throws OpenDcsDataException;

    /**
     * Writes an computation app to the database.
     * @throws DbIoException on Database IO error.
     */
    void writeComputationApp(DataTransaction tx, CompAppInfo app) throws OpenDcsDataException;

    /**
     * Deletes a computation app.
     * Caller is responsible to check to make sure it's OK to do this.
     */
    void deleteComputationApp(DataTransaction tx, CompAppInfo app) throws OpenDcsDataException;
     ...
     * another process.
     */
    Optional<TsdbCompLock> obtainCompProcLock(DataTransaction tx, CompAppInfo appInfo, int pid, String host ) throws OpenDcsDataException;    
     ...
     * @throws LockBusyException if lock cannot be released.
     */
    void releaseCompProcLock(DataTransaction tx, TsdbCompLock lock ) throws OpenDcsDataException;
     ...
     * 
     * @param lock the lock object.
     * @return true or false if the lock is busy
     * @throws DbIoException if error reading lock info from db.
     * @throws LockBusyException if the lock has been deleted.
     */
    boolean checkCompProcLockBusy(DataTransaction tx,  TsdbCompLock lock) throws OpenDcsDataException;
     ...
     * @throws DbIoException on Database IO error.
     */
     List<TsdbCompLock> getAllCompProcLocks(DataTransaction tx) throws OpenDcsDataException;
     ...
     * @param appId The application key
     */
    Optional<ZonedDateTime> getLastModified(DataTransaction tx, DbKey appId) throws OpenDcsDataException;
}
