...
create or replace public synonym dcp_trans_day_map for ${TSDB_ADM_SCHEMA}.dcp_trans_day_map;
...
begin
	...
	loop
        ...
        execute immediate 'create or replace public synonym dcp_trans_data_' || suffix || ' for ${TSDB_ADM_SCHEMA}.dcp_trans_data_' || suffix;
        execute immediate 'create or replace public synonym dcp_trans_' || suffix || ' for ${TSDB_ADM_SCHEMA}.dcp_trans_' || suffix;
		/* Create Indexes */
