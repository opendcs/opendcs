...
public class CwmsOracleConfiguration implements Configuration
{
    ...
    private static final String CWMS_SCHEMA_IMAGE = System.getProperty("opendcs.cwms.schema.image","ghcr.io/hydrologicengineeringcenter/cwms-database/cwms/schema_installer:25-07-01-RC06");
