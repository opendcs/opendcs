/*
*  $Id: ProcessXio.java,v 1.1 2023/05/15 18:33:56 mmaloney Exp $
*
*  $Log: ProcessXio.java,v $
...
{
	private ApiLrgsProcStatus ap = null;;
	...
	*/
	public ProcessXio(ApiLrgsProcStatus ap, LrgsStatusXio parent)
	{
		super();
		this.ap = ap;
		this.parent = parent;
	...
	*/
	public void set(int tag, long value)
	{
		...
		{
		case lsnTag:
			ap.setLastSeqNum(value);
			break;
		case lptTag:
			ap.setLastPollTime(new Date(value));
			break;
		case lmtTag:
			ap.setLastMsgTime(new Date(value));
			break;
		case scTag:
			ap.setStaleCount((int)value);
			break;
		}
	}
