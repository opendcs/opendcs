...
`1 Overview <#overview>`__\ `1 <#overview>`__

`1.1 Glossary and List of
Acronyms <#glossary-and-list-of-acronyms>`__\ `3 <#glossary-and-list-of-acronyms>`__

`1.2 Document History <#document-history>`__\ `4 <#document-history>`__

`2 Theory of
Operation <#theory-of-operation>`__\ `6 <#theory-of-operation>`__

`2.1 Time Series Database
Assumptions <#time-series-database-assumptions>`__\ `7 <#time-series-database-assumptions>`__

`2.2 CP and DECODES Mapping to
HDB <#cp-and-decodes-mapping-to-hdb>`__\ `8 <#cp-and-decodes-mapping-to-hdb>`__

`2.3 Computation
Meta-Data <#computation-meta-data>`__\ `11 <#computation-meta-data>`__

`2.3.1 Computations Meta-Data
ERD <#computations-meta-data-erd>`__\ `13 <#computations-meta-data-erd>`__

`2.4 Tools Provided with the
CP <#tools-provided-with-the-cp>`__\ `14 <#tools-provided-with-the-cp>`__

`2.5 How the Computation Processor
Works <#how-the-computation-processor-works>`__\ `15 <#how-the-computation-processor-works>`__

`2.5.1 Algorithms and
Computations <#algorithms-and-computations>`__\ `15 <#algorithms-and-computations>`__

`2.5.2 How to Determine which Computations to
Execute <#how-to-determine-which-computations-to-execute>`__\ `15 <#how-to-determine-which-computations-to-execute>`__

`2.5.3 Retrieving Additional Data Needed in a
Computation <#retrieving-additional-data-needed-in-a-computation>`__\ `16 <#retrieving-additional-data-needed-in-a-computation>`__

`2.5.4 Time Slice and Aggregating
Algorithms <#time-slice-and-aggregating-algorithms>`__\ `16 <#time-slice-and-aggregating-algorithms>`__

`2.5.5 Handling Deleted
Data <#handling-deleted-data>`__\ `18 <#handling-deleted-data>`__

`2.5.6 Handling Missing Data <#_Toc66281555>`__\ `18 <#_Toc66281555>`__

`2.5.7 Handling Questionable
Data <#handling-questionable-data>`__\ `19 <#handling-questionable-data>`__

`2.5.8 Automatic
Deltas <#automatic-deltas>`__\ `20 <#automatic-deltas>`__

`2.5.9 Handling Failed
Computations <#handling-failed-computations>`__\ `21 <#handling-failed-computations>`__

`2.6 Executable Programs Included with
CP <#executable-programs-included-with-cp>`__\ `22 <#executable-programs-included-with-cp>`__

`2.7 Timed
Computations <#timed-computations>`__\ `23 <#timed-computations>`__

`3 The Computation
Editor <#the-computation-editor>`__\ `24 <#the-computation-editor>`__

`3.1 The List Tabs <#the-list-tabs>`__\ `25 <#the-list-tabs>`__

`3.1.1 Action Buttons <#action-buttons>`__\ `27 <#action-buttons>`__

`3.1.2 Deleting Records that are ‘In
Use’ <#deleting-records-that-are-in-use>`__\ `28 <#deleting-records-that-are-in-use>`__

`3.1.3 Crisp First Line in Comment
Areas <#crisp-first-line-in-comment-areas>`__\ `28 <#crisp-first-line-in-comment-areas>`__

`3.1.4 Sorting the
Lists <#sorting-the-lists>`__\ `28 <#sorting-the-lists>`__

`3.2 Algorithm Edit
Tab <#algorithm-edit-tab>`__\ `29 <#algorithm-edit-tab>`__

`3.2.1 Select Algorithm Executable
Class <#select-algorithm-executable-class>`__\ `31 <#select-algorithm-executable-class>`__

`3.3 6-Hour Holdout Algorithm
Example <#hour-holdout-algorithm-example>`__\ `32 <#hour-holdout-algorithm-example>`__

`3.4 Computation Edit
Tab <#computation-edit-tab>`__\ `33 <#computation-edit-tab>`__

`3.4.1 Engineering
Units <#engineering-units>`__\ `36 <#engineering-units>`__

`3.4.2 Options for handling Missing
Data <#options-for-handling-missing-data>`__\ `36 <#options-for-handling-missing-data>`__

`3.4.3 Computation
Properties <#computation-properties>`__\ `36 <#computation-properties>`__

`3.4.4 Running Computations
Interactively <#running-computations-interactively>`__\ `36 <#running-computations-interactively>`__

`3.5 Process Edit Tab <#process-edit-tab>`__\ `38 <#process-edit-tab>`__

`4 Time Series Groups and
Computations <#time-series-groups-and-computations>`__\ `40 <#time-series-groups-and-computations>`__

`4.1 Time Series Identifiers in
HDB <#time-series-identifiers-in-hdb>`__\ `40 <#time-series-identifiers-in-hdb>`__

`4.2 Time Series Identifiers in
CWMS <#time-series-identifiers-in-cwms>`__\ `40 <#time-series-identifiers-in-cwms>`__

`4.3 What is a Time Series
Group? <#what-is-a-time-series-group>`__\ `41 <#what-is-a-time-series-group>`__

`4.4 Time Series Group
Editor <#time-series-group-editor>`__\ `42 <#time-series-group-editor>`__

`4.4.1 Filtering by Location, Param, and Version in
CWMS <#filtering-by-location-param-and-version-in-cwms>`__\ `46 <#filtering-by-location-param-and-version-in-cwms>`__

`4.4.2 Evaluating Time Series ID
Components <#evaluating-time-series-id-components>`__\ `47 <#evaluating-time-series-id-components>`__

`4.5 Using a Group in a
Computation <#using-a-group-in-a-computation>`__\ `48 <#using-a-group-in-a-computation>`__

`4.6 A Group Computation Example
(HDB) <#a-group-computation-example-hdb>`__\ `50 <#a-group-computation-example-hdb>`__

`4.7 Computation Chains with
Groups <#computation-chains-with-groups>`__\ `51 <#computation-chains-with-groups>`__

`4.8 CWMS Comp Param Substitution with
Wildcards <#cwms-comp-param-substitution-with-wildcards>`__\ `52 <#cwms-comp-param-substitution-with-wildcards>`__

`5 Algorithms Provided in the Computation
Processor <#algorithms-provided-in-the-computation-processor>`__\ `53 <#algorithms-provided-in-the-computation-processor>`__

`5.1 Common Properties to
Algorithms <#common-properties-to-algorithms>`__\ `53 <#common-properties-to-algorithms>`__

`5.2 AddToPrevious <#addtoprevious>`__\ `55 <#addtoprevious>`__

`5.3 Average <#average>`__\ `56 <#average>`__

`5.4 Bridge Clearance <#bridge-clearance>`__\ `57 <#bridge-clearance>`__

`5.5 Choose One <#choose-one>`__\ `58 <#choose-one>`__

`5.6 Copy <#copy>`__\ `59 <#copy>`__

`5.7 Copy No
Overwrite <#copy-no-overwrite>`__\ `59 <#copy-no-overwrite>`__

`5.8 Dis-Aggregate <#dis-aggregate>`__\ `60 <#dis-aggregate>`__

`5.9 Incremental
Precip <#incremental-precip>`__\ `61 <#incremental-precip>`__

`5.10 Resample <#resample>`__\ `62 <#resample>`__

`5.11 Reservoir Full <#reservoir-full>`__\ `62 <#reservoir-full>`__

`5.12 Running Average <#running-average>`__\ `63 <#running-average>`__

`5.12.1
CentralRunningAverage <#centralrunningaverage>`__\ `65 <#centralrunningaverage>`__

`5.13 ScalerAdder <#scaleradder>`__\ `66 <#scaleradder>`__

`5.14 Subsample <#subsample>`__\ `67 <#subsample>`__

`5.15 Sum Over Time <#sum-over-time>`__\ `68 <#sum-over-time>`__

`5.16 Rating Calculations with USGS RDB
Files <#rating-calculations-with-usgs-rdb-files>`__\ `69 <#rating-calculations-with-usgs-rdb-files>`__

`5.17 Rating with simple ASCII Table
Files <#rating-with-simple-ascii-table-files>`__\ `70 <#rating-with-simple-ascii-table-files>`__

`5.18 USGS Equation <#usgs-equation>`__\ `71 <#usgs-equation>`__

`5.19 Fill Forward <#fill-forward>`__\ `72 <#fill-forward>`__

`5.20 Expression Parser
Algorithm <#expression-parser-algorithm>`__\ `74 <#expression-parser-algorithm>`__

`5.20.1 Example of Using Expression Parser for Conditional
Rating <#example-of-using-expression-parser-for-conditional-rating>`__\ `78 <#example-of-using-expression-parser-for-conditional-rating>`__

`5.21 Division
Algorithm <#division-algorithm>`__\ `79 <#division-algorithm>`__

`5.22 Weighted Water
Temperature <#weighted-water-temperature>`__\ `80 <#weighted-water-temperature>`__

`5.23 FlowResIn – Compute Reservoir Inflow at
LRP <#flowresin-compute-reservoir-inflow-at-lrp>`__\ `81 <#flowresin-compute-reservoir-inflow-at-lrp>`__

`5.24 Multiplication
Algorithm <#multiplication-algorithm>`__\ `82 <#multiplication-algorithm>`__

`5.25 Stat (Statistics)
Algorithm <#stat-statistics-algorithm>`__\ `82 <#stat-statistics-algorithm>`__

`5.26 PeriodToDate
Algorithm <#periodtodate-algorithm>`__\ `84 <#periodtodate-algorithm>`__

`5.27 GroupAdder
Algorithm <#groupadder-algorithm>`__\ `85 <#groupadder-algorithm>`__

`6 Python
Algorithms <#python-algorithms>`__\ `86 <#python-algorithms>`__

`6.1 Creating a New Python
Algorithm <#creating-a-new-python-algorithm>`__\ `86 <#creating-a-new-python-algorithm>`__

`6.2 Accessing the Time Slice Time
Value <#accessing-the-time-slice-time-value>`__\ `91 <#accessing-the-time-slice-time-value>`__

`6.3 Creating a Computation that Uses the
Algorithm <#creating-a-computation-that-uses-the-algorithm>`__\ `92 <#creating-a-computation-that-uses-the-algorithm>`__

`6.4 Time Series Parameters in the Python
Scripts <#time-series-parameters-in-the-python-scripts>`__\ `93 <#time-series-parameters-in-the-python-scripts>`__

`6.5 Conditional Rating
Example <#conditional-rating-example>`__\ `94 <#conditional-rating-example>`__

`6.6 Reservoir Estimated
Inflow <#reservoir-estimated-inflow>`__\ `96 <#reservoir-estimated-inflow>`__

`7 XML Import/Export
Utilities <#xml-importexport-utilities>`__\ `100 <#xml-importexport-utilities>`__

`7.1 XML Format for Computation
Meta-Data <#xml-format-for-computation-meta-data>`__\ `100 <#xml-format-for-computation-meta-data>`__

`7.2 Import Utility <#import-utility>`__\ `102 <#import-utility>`__

`7.3 Export Utility <#export-utility>`__\ `102 <#export-utility>`__

`8 Starting the Computation Processor
Daemons <#starting-the-computation-processor-daemons>`__\ `103 <#starting-the-computation-processor-daemons>`__

`8.1 The Computation
Processor <#the-computation-processor>`__\ `103 <#the-computation-processor>`__

`8.2 The Computation Dependencies
Daemon <#the-computation-dependencies-daemon>`__\ `104 <#the-computation-dependencies-daemon>`__

`9 Interactive Run-Computations
GUI <#interactive-run-computations-gui>`__\ `106 <#interactive-run-computations-gui>`__

`10 Other Utilities <#other-utilities>`__\ `108 <#other-utilities>`__

`10.1 List All
Computations <#list-all-computations>`__\ `108 <#list-all-computations>`__

`10.2 List All
Algorithms <#list-all-algorithms>`__\ `108 <#list-all-algorithms>`__

`10.3 List Locks Used by Computation
Processes <#list-locks-used-by-computation-processes>`__\ `108 <#list-locks-used-by-computation-processes>`__

`10.4 List the CP_COMP_DEPENDS
Table <#list-the-cp_comp_depends-table>`__\ `109 <#list-the-cp_comp_depends-table>`__

`10.5 Output Time Series
Data <#output-time-series-data>`__\ `110 <#output-time-series-data>`__

`10.6 Show New Data Assigned to
Computations <#show-new-data-assigned-to-computations>`__\ `110 <#show-new-data-assigned-to-computations>`__

`10.7 Delete a Time
Series <#delete-a-time-series>`__\ `111 <#delete-a-time-series>`__

`10.8 Import Time Series Data from a
File <#import-time-series-data-from-a-file>`__\ `111 <#import-time-series-data-from-a-file>`__

`10.9 Evaluate a Time Series
Group <#evaluate-a-time-series-group>`__\ `112 <#evaluate-a-time-series-group>`__

`10.10 Convert Individual Computations to Groups (HDB
Only) <#convert-individual-computations-to-groups-hdb-only>`__\ `112 <#convert-individual-computations-to-groups-hdb-only>`__

`10.10.2 Prepare Time Series
Group <#prepare-time-series-group>`__\ `112 <#prepare-time-series-group>`__

`10.10.3 Prepare a Computation that uses the
Group <#prepare-a-computation-that-uses-the-group>`__\ `113 <#prepare-a-computation-that-uses-the-group>`__

`10.10.4 Run the
Utility <#run-the-utility>`__\ `114 <#run-the-utility>`__

`10.10.5 How the Matching is
Done <#how-the-matching-is-done>`__\ `114 <#how-the-matching-is-done>`__

`10.11 Execute Computations over Time Range from Command
Line <#execute-computations-over-time-range-from-command-line>`__\ `116 <#execute-computations-over-time-range-from-command-line>`__

`11 Features Specific to USBR
HDB <#features-specific-to-usbr-hdb>`__\ `119 <#features-specific-to-usbr-hdb>`__

`11.1 Model Run ID <#model-run-id>`__\ `119 <#model-run-id>`__

`11.2 HDB Specific
Algorithms <#hdb-specific-algorithms>`__\ `119 <#hdb-specific-algorithms>`__

`11.2.1
BeginofPeriodAlg <#beginofperiodalg>`__\ `120 <#beginofperiodalg>`__

`11.2.2 CallProcAlg <#callprocalg>`__\ `121 <#callprocalg>`__

`11.2.3
DynamicAggregatesAlg <#dynamicaggregatesalg>`__\ `122 <#dynamicaggregatesalg>`__

`11.2.4 End Of Period
Algorithm <#end-of-period-algorithm>`__\ `124 <#end-of-period-algorithm>`__

`11.2.5 EOPInterpAlg (End Of Period
Interpolating) <#eopinterpalg-end-of-period-interpolating>`__\ `124 <#eopinterpalg-end-of-period-interpolating>`__

`11.2.6
EquationSolverAlg <#equationsolveralg>`__\ `125 <#equationsolveralg>`__

`11.2.7
FlowToVolumeAlg <#flowtovolumealg>`__\ `126 <#flowtovolumealg>`__

`11.2.8 HdbACAPSRating <#hdbacapsrating>`__\ `127 <#hdbacapsrating>`__

`11.2.9 HdbEvaporation <#hdbevaporation>`__\ `127 <#hdbevaporation>`__

`11.2.10 HdbRating
Algorithm <#hdbrating-algorithm>`__\ `128 <#hdbrating-algorithm>`__

`11.2.11 HdbShiftRating
Algorithm <#hdbshiftrating-algorithm>`__\ `129 <#hdbshiftrating-algorithm>`__

`11.2.12
InflowAdvancedAlg <#inflowadvancedalg>`__\ `130 <#inflowadvancedalg>`__

`11.2.13 InflowBasicAlg <#inflowbasicalg>`__\ `131 <#inflowbasicalg>`__

`11.2.14
PowerToEnergyAlg <#powertoenergyalg>`__\ `132 <#powertoenergyalg>`__

`11.2.15 SideInflowAlg <#sideinflowalg>`__\ `133 <#sideinflowalg>`__

`11.2.16
VolumeToFlowAlg <#volumetoflowalg>`__\ `134 <#volumetoflowalg>`__

`11.3 HDB Site Specific
Algorithms <#hdb-site-specific-algorithms>`__\ `135 <#hdb-site-specific-algorithms>`__

`12 Features Specific to
CWMS <#features-specific-to-cwms>`__\ `136 <#features-specific-to-cwms>`__

`12.1 Rating Tables within the CWMS
Database <#rating-tables-within-the-cwms-database>`__\ `136 <#rating-tables-within-the-cwms-database>`__

`12.2 Virtual Gage
Algorithm <#virtual-gage-algorithm>`__\ `136 <#virtual-gage-algorithm>`__

`12.3 Validation with DATCHK
Files <#validation-with-datchk-files>`__\ `137 <#validation-with-datchk-files>`__

`12.3.1 Results of
Validation <#results-of-validation>`__\ `138 <#results-of-validation>`__

`12.3.2 DATCHK Configuration
Files <#datchk-configuration-files>`__\ `139 <#datchk-configuration-files>`__

`12.4 Rating Algorithm for a Single Independent
Value <#rating-algorithm-for-a-single-independent-value>`__\ `141 <#rating-algorithm-for-a-single-independent-value>`__

`12.5 Rating Algorithm for Multiple Independent
Values <#rating-algorithm-for-multiple-independent-values>`__\ `142 <#rating-algorithm-for-multiple-independent-values>`__

`12.6 CWMS Parameters and DECODES Data
Types <#cwms-parameters-and-decodes-data-types>`__\ `146 <#cwms-parameters-and-decodes-data-types>`__

`12.7 Validation from CWMS Screening
Database <#validation-from-cwms-screening-database>`__\ `147 <#validation-from-cwms-screening-database>`__

`12.7.1 CWMS Screening Database
Records <#cwms-screening-database-records>`__\ `147 <#cwms-screening-database-records>`__

`12.7.2 Importing DATCHK Screening
Information <#importing-datchk-screening-information>`__\ `148 <#importing-datchk-screening-information>`__

`12.7.3 Export Screening
Information <#export-screening-information>`__\ `149 <#export-screening-information>`__

`12.7.4 Importing Screening
Records <#importing-screening-records>`__\ `151 <#importing-screening-records>`__

`12.7.5 The Screening
Algorithm <#the-screening-algorithm>`__\ `151 <#the-screening-algorithm>`__

`12.8 CWMS Screening
Editor <#cwms-screening-editor>`__\ `152 <#cwms-screening-editor>`__
...
-  For HDB this is a prefix denoting real (R_) or modeled (M_) data.
...
.. image:: ./media/image3.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2012-08-31 at
   9.34.15 AM.png
   :width: 6.49444in
   :height: 3.78958in
...
A string element called a “table selector” is used to denote real (R_)
verses modeled (M_) data.
...
.. image:: ./media/image7.jpeg
   :alt: Macintosh
   HD:Users:mmaloney:covesoftware:Clients:USBR:2012-CP-Work:ERD-Computations.jpg
   :width: 6.5in
   :height: 7.33333in
...
.. image:: ./media/image12.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2015-11-18 at
   9.34.07 AM.png
   :width: 6in
   :height: 5.15835in
...
.. image:: ./media/image17.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2012-09-03 at
   10.34.20 AM.png
   :width: 5.25in
   :height: 3.6759in
...
.. image:: ./media/image18.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2013-08-19 at
   9.03.13 AM.png
   :width: 5.75in
   :height: 3.62874in
...
|image3|\ |Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2012-11-12 at
4.10.31 PM.png|
...
.. image:: ./media/image22.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2016-11-03 at
   10.50.34 AM.png
   :width: 6.49514in
   :height: 3.06944in
...
described below, specify time series with a 4, 5, or 6 “path name”:
   ...
   RUEWEACO.8.hour.M_.1.1 Hourly modeled precip at the same site, model
...
.. image:: ./media/image27.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2016-10-11 at
   1.46.43 PM.png
   :width: 5.98889in
   :height: 1.50763in
...
|                 |       | time-slice.                                |
+-----------------+-------+--------------------------------------------+
| interpDeltas    | Bo    | Default = false. When computing an         |
|                 | olean | automatic delta, if one of the bounding    |
...
+-----------------+-------+--------------------------------------------+
| ag              | S     | Default is set in decodes.properties. This |
| gregateTimeZone | tring | can be set on an algorithm or computation  |
...
+-----------------+-------+--------------------------------------------+
| *rolen          | S     | See section 3.4.2. Normally this is set in |
| ame*\ \_MISSING | tring | the computation parameter dialog. You can  |
...
|            | Type**  | ault** |                                     |
+------------+---------+--------+-------------------------------------+
| pre_\*     | String  | (none) | Lines of script to execute before   |
|            |         |        | time slices.                        |
+------------+---------+--------+-------------------------------------+
| ex_\*      | String  | (none) | Lines of script to execute for each |
|            |         |        | time slice.                         |
+------------+---------+--------+-------------------------------------+
| post_\*    | String  | (none) | Lines of script to execute after    |
|            |         |        | each time slice.                    |
+------------+---------+--------+-------------------------------------+
...
-  All properties with names beginning with “pre_” are sorted into a
...
-  All properties with names beginning with “ex_” are sorted into a
...
-  All properties with names beginning with “post_” are sorted into a
...
.. image:: ./media/image34.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2016-03-19 at
   4.08.30 PM.png
   :width: 6.48542in
   :height: 4.61389in
...
.. image:: ./media/image36.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2016-03-22 at
   12.43.35 PM.png
   :width: 6.49514in
   :height: 3.24722in
...
.. image:: ./media/image39.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2018-05-30 at
   4.16.46 PM.png
   :width: 6.48542in
   :height: 2.03958in
...
.. image:: ./media/image40.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2016-03-21 at
   7.23.31 PM.png
   :width: 6.49514in
   :height: 3.85139in
...
9936, "TESTSITE1.65.instant.R_", 146, "regtest_006-1-DailyAverage", 50,
"compproc_regtest"

9944, "TESTSITE3.65.instant.R_", 146, "regtest_006-1-DailyAverage", 50,
"compproc_regtest"

9945, "TESTSITE1.66.day.R_", 147, "regtest_006-2-Disagg", 50,
"compproc_regtest"

9946, "TESTSITE3.66.day.R_", 147, "regtest_006-2-Disagg", 50,
"compproc_regtest"
...
-  tabselect = table selector, e.g. “R_”
...
Algorithm to copy these time series values to a modeled (M_) table with
...
+-----------------+--------+----------+-------------------------------+
| min_            | i      | 1        | Number of input values        |
...
|                | ype** |        |                                    |
+----------------+-------+--------+------------------------------------+
| variableShift  | Bo    | false  | False means to use a constant      |
|                | olean |        | shift value provided by the        |
|                |       |        | “singleShift” property. True means |
|                |       |        | to use a separate lookup table for |
|                |       |        | shifts.                            |
+----------------+-------+--------+------------------------------------+
| singleShift    | d     | 0      | If variableShift == false, which   |
|                | ouble |        | is the default, then this property |
|                |       |        | provides the single shift value to |
|                |       |        | be used for all time slices.       |
+----------------+-------+--------+------------------------------------+
| shiftTableType | S     | Stage  | if variableShift is set to True,   |
|                | tring | Shift  | then a separate table is used to   |
|                |       |        | lookup a shift value at each time  |
|                |       |        | slice. This property provides the  |
|                |       |        | HDB_TABLE type.                    |
+----------------+-------+--------+------------------------------------+
| l              | S     | Stage  | This property is new in OpenDCS    |
| ookupTableType | tring | Flow   | 6.3. In previous releases it was   |
...
.. image:: ./media/image52.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2012-11-20 at
   11.15.26 AM.png
   :width: 6.49444in
   :height: 4.52639in
...
.. image:: ./media/image56.png
   :alt: Macintosh HD:Users:mmaloney:Desktop:Screen Shot 2015-11-17 at
   4.34.09 PM.png
   :width: 6.49514in
   :height: 3.88819in
