...
import type { ApiConfigScriptSensor } from "opendcs-api";
...
export interface SensorConversionProperties {
  sensors: ApiConfigScriptSensor[];
}

const SensorConversion: React.FC<SensorConversionProperties> = ({ sensors }) => {
  const table = useRef<DataTableRef>(null);

  const columns = [
    { data: "sensorNumber", defaultContent: "" },
    { data: null, defaultContent: "" },
    { data: "unitConverter.ucId", defaultContent: "" },
