...
<div
	...
	<div class="sidebar-mobile-toggler text-center">
		<a href="#" class="sidebar-mobile-main-toggle"> <i
			...
			class="bi bi-fullscreen"></i> <i class="bi bi-fullscreen-exit"></i>
		</a>
	</div>
	<%-- /sidebar mobile toggler --%>
	...
	<div class="sidebar-content">
		<a href="#" class="nav-link sidebar-control sidebar-main-toggle d-none d-md-block" aria-label="Toggle sidebar">
		...
		<div class="card card-sidebar-mobile">
			<ul class="nav nav-sidebar" data-nav-type="accordion">
				...
				<li
					...
					<a href="#" class="nav-link"><i class="bi bi-files"></i> <span>Decodes
					...
					<ul class="nav nav-group-sub" data-submenu-title="rl_edit"
						...
						<li
							...
							<a href="platforms" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Platforms</span>
						</a>
						</li>
						<li
							...
							<a href="sites" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Sites</span>
						</a>
						</li>
						<li
							...
							<a href="configs" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Configs</span>
						</a>
						</li>
						<li
							...
							<a href="presentation" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Presentation</span>
						</a>
						</li>
						<li
							...
							<a href="routing" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Routing</span>
						</a>
						</li>
						<li
							...
							<a href="sources" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Sources</span>
						</a>
						</li>
						<li
							...
							<a href="netlist" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Netlists</span>
						</a>
						</li>
						<li
							...
							<a href="schedule" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Schedule Entry</span>
						</a>
						</li>
					</ul>
				</li>
				<li
					...
					<a href="#" class="nav-link"><i class="bi bi-files"></i> <span>Computations</span></a>
					<ul class="nav nav-group-sub" data-submenu-title="rl_edit"
						...
						<li
							...
							<a href="algorithms" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Algorithms</span>
						</a>
						</li>
						<li
							...
							<a href="computations" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Computations</span>
						</a>
						</li>
						<li
							...
							<a href="processes" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Processes</span>
						</a>
						</li>
					</ul>
				</li>
				<li
					...
					<a href="#" class="nav-link"><i class="bi bi-files"></i> <span>Reflist
							Editor</span></a>
					<ul class="nav nav-group-sub" data-submenu-title="rl_edit"
						...
						<li
							...
							<a href="enumerations" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Enumerations</span>
						</a>
						</li>
						<li
							...
							<a href="engineering_units" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Engineering
									Units</span>
						</a>
						</li>
						...
						<li
							...
							<a href="eu_conversions" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>EU Conversions</span>
						</a>
						</li>
						<li
							...
							<a href="seasons" class="nav-link"> <i
								class="bi bi-file-text"></i> <span>Seasons</span>
						</a>
						</li>
					</ul>
				</li>
