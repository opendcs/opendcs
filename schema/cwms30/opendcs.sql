...
(
	...
	GROUP_ID NUMBER(18),
	-- Null means this is not a seasonal computation
	SEASON_ID NUMBER(18),
	db_office_code integer default &dflt_office_code,
...
CREATE TABLE SEASON
(
	SEASON_ID NUMBER(18) NOT NULL,
	-- Unique abbreviation for this season
	SEASON_ABBR VARCHAR2(24) NOT NULL,
	SEASON_FULL_NAME VARCHAR2(64) NOT NULL,
	-- MM/DD-HH:MM:SS
	SEASON_START VARCHAR2(14) NOT NULL,
	-- End of season (not inclusive) MM:DD-HH:MM:SS
	SEASON_END VARCHAR2(14) NOT NULL,
	-- Java time zone ID. If null, defaults to TSDB_PROPERTIES.timezone setting.
	SEASON_TIMEZONE VARCHAR2(64),
	db_office_code integer default &dflt_office_code,
...
ALTER TABLE CP_COMPUTATION
	ADD CONSTRAINT CP_COMPUTATION_FKSE
