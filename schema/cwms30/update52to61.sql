...
ALTER TABLE DATAPRESENTATION ADD MAX_VALUE DOUBLE PRECISION;
ALTER TABLE DATAPRESENTATION ADD MIN_VALUE DOUBLE PRECISION;
...
create unique index datatypecode_ididx
    on datatype (standard, code, db_office_code) &tbl_space;
...
ALTER TABLE CCP.CP_ALGORITHM MODIFY(ALGORITHM_ID NUMBER(18));

ALTER TABLE CCP.CP_ALGORITHM MODIFY(EXEC_CLASS VARCHAR2(240 BYTE));


ALTER TABLE CCP.CP_ALGORITHM
MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.CP_ALGO_PROPERTY MODIFY(ALGORITHM_ID NUMBER(18));

ALTER TABLE CCP.CP_ALGO_PROPERTY MODIFY(PROP_VALUE  NULL);

ALTER TABLE CCP.CP_ALGO_TS_PARM MODIFY(ALGORITHM_ID NUMBER(18));
...
MODIFY(GROUPID NUMBER(18));

ALTER TABLE CCP.DATASOURCEGROUPMEMBER
MODIFY(MEMBERID NUMBER(18));

ALTER TABLE CCP.DATATYPE
 ADD (DB_OFFICE_CODE  INTEGER                       DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));
...
ALTER TABLE CCP.ENUM MODIFY(ID NUMBER(18));

ALTER TABLE CCP.ENUM
  MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.ENUMVALUE MODIFY(ENUMID NUMBER(18));

ALTER TABLE CCP.EQUIPMENTMODEL MODIFY(ID NUMBER(18));

ALTER TABLE CCP.EQUIPMENTMODEL
MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.EQUIPMENTPROPERTY RENAME COLUMN VALUE TO PROP_VALUE;

ALTER TABLE CCP.EQUIPMENTPROPERTY MODIFY(EQUIPMENTID NUMBER(18));

ALTER TABLE CCP.HDB_LOADING_APPLICATION MODIFY(LOADING_APPLICATION_ID NUMBER(18));

ALTER TABLE CCP.HDB_LOADING_APPLICATION MODIFY(MANUAL_EDIT_APP  DEFAULT 'N');

ALTER TABLE CCP.HDB_LOADING_APPLICATION
  MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.NETWORKLIST MODIFY(ID NUMBER(18));
...
ALTER TABLE CCP.NETWORKLISTENTRY MODIFY(NETWORKLISTID NUMBER(18));

ALTER TABLE CCP.PLATFORMCONFIG MODIFY(ID NUMBER(18));

ALTER TABLE CCP.PLATFORMCONFIG MODIFY(EQUIPMENTID NUMBER(18));

ALTER TABLE CCP.PLATFORMCONFIG
  MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.PRESENTATIONGROUP MODIFY(ID NUMBER(18));

ALTER TABLE CCP.PRESENTATIONGROUP MODIFY(INHERITSFROM NUMBER(18));
...
ALTER TABLE CCP.PRESENTATIONGROUP
MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.REF_LOADING_APPLICATION_PROP MODIFY(LOADING_APPLICATION_ID NUMBER(18));

ALTER TABLE CCP.ROUTINGSPEC MODIFY(ID NUMBER(18));

ALTER TABLE CCP.ROUTINGSPEC MODIFY(DATASOURCEID NUMBER(18) NOT NULL);
...
ALTER TABLE CCP.ROUTINGSPEC
MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.ROUTINGSPECNETWORKLIST
MODIFY(ROUTINGSPECID NUMBER(18));
...
ALTER TABLE CCP.ROUTINGSPECPROPERTY MODIFY(ROUTINGSPECID NUMBER(18));

ALTER TABLE CCP.SITENAME MODIFY(SITEID NUMBER(18));

ALTER TABLE CCP.SITE_PROPERTY MODIFY(SITE_ID NUMBER(18));

ALTER TABLE CCP.TSDB_DATABASE_VERSION RENAME COLUMN VERSION TO DB_VERSION;

ALTER TABLE CCP.TSDB_GROUP MODIFY(GROUP_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP
MODIFY(DB_OFFICE_CODE  DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_DT MODIFY(GROUP_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_DT MODIFY(DATA_TYPE_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_GROUP MODIFY(PARENT_GROUP_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_GROUP MODIFY(CHILD_GROUP_ID NUMBER(18));
...
ALTER TABLE CCP.TSDB_GROUP_MEMBER_OTHER MODIFY(GROUP_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_OTHER MODIFY(MEMBER_VALUE VARCHAR2(240 BYTE));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_SITE MODIFY(GROUP_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_SITE MODIFY(SITE_ID NUMBER(18));

ALTER TABLE CCP.TSDB_GROUP_MEMBER_TS RENAME COLUMN data_id TO TS_ID;

ALTER TABLE CCP.TSDB_GROUP_MEMBER_TS MODIFY(GROUP_ID NUMBER(18));
ALTER TABLE CCP.TSDB_GROUP_MEMBER_TS MODIFY(TS_ID NUMBER(18));

ALTER TABLE CCP.UNITCONVERTER ADD (DB_OFFICE_CODE INTEGER
	DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE')); 
ALTER TABLE CCP.UNITCONVERTER MODIFY(ID NUMBER(18));
...
ALTER TABLE CCP.CONFIGSENSOR MODIFY(CONFIGID NUMBER(18));
...
ALTER TABLE CCP.CONFIGSENSOR MODIFY(EQUIPMENTID NUMBER(18));

ALTER TABLE CCP.CONFIGSENSORDATATYPE MODIFY(CONFIGID NUMBER(18));

ALTER TABLE CCP.CONFIGSENSORDATATYPE MODIFY(DATATYPEID NUMBER(18));
...
ALTER TABLE CCP.CONFIGSENSORPROPERTY MODIFY(CONFIGID NUMBER(18));

ALTER TABLE CCP.CP_COMPUTATION DROP COLUMN SEASON_ID;

ALTER TABLE CCP.CP_COMPUTATION MODIFY(COMPUTATION_ID NUMBER(18));

ALTER TABLE CCP.CP_COMPUTATION MODIFY(ALGORITHM_ID NUMBER(18));

ALTER TABLE CCP.CP_COMPUTATION MODIFY(LOADING_APPLICATION_ID NUMBER(18));

ALTER TABLE CCP.CP_COMPUTATION MODIFY(ENABLED VARCHAR2(5 BYTE) NOT NULL);

UPDATE CCP.CP_COMPUTATION SET ENABLED = 'FALSE' 
	WHERE ENABLED = 'N' OR ENABLED IS NULL;

ALTER TABLE CCP.CP_COMPUTATION MODIFY(ENABLED DEFAULT 'FALSE');

ALTER TABLE CCP.CP_COMPUTATION MODIFY(ENABLED NOT NULL);

ALTER TABLE CCP.CP_COMPUTATION MODIFY(GROUP_ID NUMBER(18));

ALTER TABLE CP_COMP_DEPENDS RENAME COLUMN SITE_DATATYPE_ID TO TS_ID;

ALTER TABLE CP_COMP_DEPENDS MODIFY(TS_ID NUMBER(18));

ALTER TABLE CP_COMP_DEPENDS MODIFY(COMPUTATION_ID NUMBER(18));
...
ALTER TABLE CCP.CP_COMP_PROC_LOCK MODIFY(LOADING_APPLICATION_ID NUMBER(18));

ALTER TABLE CCP.CP_COMP_PROPERTY MODIFY(COMPUTATION_ID NUMBER(18));
...
ALTER TABLE CCP.CP_COMP_TS_PARM ADD (SITE_ID  NUMBER(18));

ALTER TABLE CCP.CP_COMP_TS_PARM MODIFY(COMPUTATION_ID NUMBER(18));

ALTER TABLE CCP.CP_COMP_TS_PARM MODIFY(SITE_DATATYPE_ID NUMBER(18) NULL);
...
ALTER TABLE CCP.CP_COMP_TS_PARM MODIFY(DATATYPE_ID NUMBER(18));

ALTER TABLE CCP.DATAPRESENTATION ADD (MAX_VALUE  FLOAT(126));

ALTER TABLE CCP.DATAPRESENTATION ADD (MIN_VALUE  FLOAT(126));

ALTER TABLE CCP.DATAPRESENTATION MODIFY(ID NUMBER(18));

ALTER TABLE CCP.DATAPRESENTATION MODIFY(GROUPID NUMBER(18));

ALTER TABLE CCP.DATAPRESENTATION MODIFY(DATATYPEID NUMBER(18) NOT NULL);

ALTER TABLE CCP.DATAPRESENTATION MODIFY(EQUIPMENTID NUMBER(18));

ALTER TABLE CCP.DECODESSCRIPT RENAME COLUMN TYPE TO SCRIPT_TYPE;

ALTER TABLE CCP.DECODESSCRIPT MODIFY(ID NUMBER(18));

ALTER TABLE CCP.DECODESSCRIPT MODIFY(CONFIGID NUMBER(18));
...
ALTER TABLE CCP.FORMATSTATEMENT MODIFY(DECODESSCRIPTID NUMBER(18));

ALTER TABLE CCP.PLATFORM MODIFY(ID NUMBER(18));
...
ALTER TABLE CCP.PLATFORM MODIFY(SITEID NUMBER(18));

ALTER TABLE CCP.PLATFORM MODIFY(CONFIGID NUMBER(18));
...
ALTER TABLE CCP.PLATFORMPROPERTY MODIFY(PLATFORMID NUMBER(18));

ALTER TABLE CCP.PLATFORMSENSOR MODIFY(PLATFORMID NUMBER(18));

ALTER TABLE CCP.PLATFORMSENSOR MODIFY(SITEID NUMBER(18));
...
ALTER TABLE CCP.PLATFORMSENSORPROPERTY MODIFY(PLATFORMID NUMBER(18));

ALTER TABLE CCP.ROUNDINGRULE MODIFY(DATAPRESENTATIONID NUMBER(18));

ALTER TABLE CCP.SCRIPTSENSOR MODIFY(DECODESSCRIPTID NUMBER(18));

ALTER TABLE CCP.SCRIPTSENSOR MODIFY(UNITCONVERTERID NUMBER(18) NOT NULL);

ALTER TABLE CCP.TRANSPORTMEDIUM ADD (DB_OFFICE_CODE  INTEGER                       DEFAULT sys_context('CCPENV','CCP_OFFICE_CODE'));

ALTER TABLE CCP.TRANSPORTMEDIUM MODIFY(PLATFORMID NUMBER(18));

ALTER TABLE CCP.TRANSPORTMEDIUM MODIFY(MEDIUMID  NOT NULL);

ALTER TABLE CCP.TRANSPORTMEDIUM MODIFY(EQUIPMENTID NUMBER(18));
...
ALTER TABLE CCP.CP_ALGO_PROPERTY ADD CONSTRAINT ALGO_PROP_UNIQUE
  UNIQUE (ALGORITHM_ID, PROP_NAME) USING INDEX CCP.ALGO_PROP_UNIQUE;
...
ALTER TABLE CCP.SITENAME
 ADD PRIMARY KEY (SITEID, NAMETYPE);
...
ALTER TABLE CCP.SCHEDULE_ENTRY
 ADD CONSTRAINT SCHEDULE_ENTRY_FKLA
  FOREIGN KEY (LOADING_APPLICATION_ID)
...
ALTER TABLE CCP.SCHEDULE_ENTRY
 ADD CONSTRAINT SCHEDULE_ENTRY_FKRS
  FOREIGN KEY (ROUTINGSPEC_ID)
  REFERENCES CCP.ROUTINGSPEC (ID);

ALTER TABLE CCP.SCHEDULE_ENTRY_STATUS
 ADD CONSTRAINT SCHEDULE_ENTRY_STATUS_FKSE
  FOREIGN KEY (SCHEDULE_ENTRY_ID)
  REFERENCES CCP.SCHEDULE_ENTRY (SCHEDULE_ENTRY_ID);
ALTER TABLE CCP.CP_COMP_DEPENDS_SCRATCHPAD
 ADD CONSTRAINT CP_COMP_DEPENDS_SCRATCHPAD_FK
  FOREIGN KEY (COMPUTATION_ID)
  REFERENCES CCP.CP_COMPUTATION (COMPUTATION_ID);

ALTER TABLE CCP.PLATFORM_STATUS
 ADD CONSTRAINT PLATFORM_STATUS_FKPL
  FOREIGN KEY (PLATFORM_ID)
  REFERENCES CCP.PLATFORM (ID);

ALTER TABLE CCP.PLATFORM_STATUS
 ADD CONSTRAINT PLATFORM_STATUS_FKSE
  FOREIGN KEY (LAST_SCHEDULE_ENTRY_STATUS_ID)
  REFERENCES CCP.SCHEDULE_ENTRY_STATUS (SCHEDULE_ENTRY_STATUS_ID);

ALTER TABLE CCP.DACQ_EVENT
 ADD CONSTRAINT DACQ_EVENT_FKPL
  FOREIGN KEY (PLATFORM_ID)
  REFERENCES CCP.PLATFORM (ID);
...
ALTER TABLE CCP.DATATYPEEQUIVALENCE
...
ALTER TABLE CCP.ENUMVALUE
 ADD CONSTRAINT ENUMVALUE_FK
  FOREIGN KEY (ENUMID)
  REFERENCES CCP.ENUM (ID);

ALTER TABLE CCP.EQUIPMENTPROPERTY
 ADD CONSTRAINT EQUIPMENTPROPERTY_FKEQ
  FOREIGN KEY (EQUIPMENTID)
  REFERENCES CCP.EQUIPMENTMODEL (ID);

ALTER TABLE CCP.NETWORKLISTENTRY
 ADD CONSTRAINT NETWORKLISTENTRY_FKNL
  FOREIGN KEY (NETWORKLISTID)
  REFERENCES CCP.NETWORKLIST (ID);

ALTER TABLE CCP.PRESENTATIONGROUP
 ADD CONSTRAINT PRESENTATIONGROUP_FKIN
  FOREIGN KEY (INHERITSFROM)
  REFERENCES CCP.PRESENTATIONGROUP (ID);
...
ALTER TABLE CCP.CONFIGSENSOR
 ADD CONSTRAINT CONFIGSENSOR_FKCO
  ...
  REFERENCES CCP.PLATFORMCONFIG (ID);
...
ALTER TABLE CCP.DATAPRESENTATION
...
ALTER TABLE CCP.PLATFORMPROPERTY
 ADD CONSTRAINT PLATFORMPROPERTY_FKPL
  FOREIGN KEY (PLATFORMID)
  REFERENCES CCP.PLATFORM (ID);

ALTER TABLE CCP.PLATFORMSENSOR
...
ALTER TABLE CCP.ROUNDINGRULE
 ADD CONSTRAINT ROUNDINGRULE_FK
  FOREIGN KEY (DATAPRESENTATIONID)
  REFERENCES CCP.DATAPRESENTATION (ID);

ALTER TABLE CCP.SCRIPTSENSOR
...
ALTER TABLE CCP.SCRIPTSENSOR
 ADD CONSTRAINT SCRIPTSENSOR_FKUC
  ...
  REFERENCES CCP.UNITCONVERTER (ID);

ALTER TABLE CCP.TRANSPORTMEDIUM
