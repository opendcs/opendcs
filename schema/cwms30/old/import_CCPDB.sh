...
bin/dbimport -r $DCSTOOL_HOME/edit-db/enum/*.xml

echo "Importing Standard Engineering Units and Conversions from edit-db ..."
bin/dbimport -r $DCSTOOL_HOME/edit-db/eu/EngineeringUnitList.xml

echo "Importing Standard Data Types from edit-db ..."
bin/dbimport -r $DCSTOOL_HOME/edit-db/datatype/DataTypeEquivalenceList.xml

echo "Importing SHEF English and CWMS Presentation Groups ..."
bin/dbimport -r $DCSTOOL_HOME/edit-db/presentation/*.xml

echo "Importing CWMS-Specific Computations..."
bin/dbimport -r $DCSTOOL_HOME/to_import/cwms-import.xml

echo "Importing CWMS information..."
bin/compimport $DCSTOOL_HOME/to_import/cwms-comps.xml

echo "Review the file 'util.log' to check for errors."
